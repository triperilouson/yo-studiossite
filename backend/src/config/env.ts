...
const envSchema = z.object({
  ...
  ADMIN_REFRESH_TOKEN_TTL_HOURS: z.coerce.number().int().min(1).max(168).default(12),
  ...
  SES_FROM_SUPPORT: z.string().email().optional().or(z.literal('')),
  SES_FROM_MARKETING: z.string().email().optional().or(z.literal('')),
  SES_FROM_SYSTEM: z.string().email().optional().or(z.literal('')),
  ...
  SUPPORT_INBOUND_WEBHOOK_SECRET: z.string().min(32).optional().or(z.literal('')),
